...
metadata = {
    'apiLevel': '2.13',
    'protocolName': 'LSP Pools | MM Plating | 8 replicates',
    'author': 'OP13 LL',
    'description': '''Plates master mix [8 replicates]  for lineage-specific primer pool evaluations. | 
                        Place completed 2x mastermixes [1-9] in slots A1-A6 and B1-B3 of tube rack.
                        Mastermixes are added to plate from top left to bottom right quadrants, by row.'''
}
